...
void setup(){
  ...
  go = new ReadyPlayerOne(width/2,height/2 - 20, 20, color(255,255,255));
  sit = new ReadyEnemy(600, 1000, 40, color(255,255,255));
...
void sendData(){
  if(abs(((go.topBound+(go.size/2)) - (sit.bottomBound-(sit.size/2)))) < 200 && abs(((go.leftBound+(go.size/2)) - (sit.rightBound-(sit.size/2)))) < 200){
    if(sit.speedX < 0){
      sit.speedX = 5;
    }
    else if(sit.speedX > 0){
      sit.speedX = -5;
    }
    if(sit.speedY < 0){
      sit.speedY = 5;
    }
    else if(sit.speedY > 0){
      sit.speedY = -5;
    }
    port.write("?1!");
    println("DANGER");
  ...
  else if(abs(((go.topBound+(go.size/2)) - (sit.bottomBound-(sit.size/2)))) < 400 && abs(((go.leftBound+(go.size/2)) - (sit.rightBound-(sit.size/2)))) < 400){
    if(sit.speedX <= 0){
      sit.speedX = 4;
    }
    else if(sit.speedX >= 0){
  ...
  else if(abs(((go.topBound+(go.size/2)) - (sit.bottomBound-(sit.size/2)))) < 600 && abs(((go.leftBound+(go.size/2)) - (sit.rightBound-(sit.size/2)))) < 600){
    if(sit.speedX <= 0){
      sit.speedX = 3;
    }
    else if(sit.speedX >= 0){
